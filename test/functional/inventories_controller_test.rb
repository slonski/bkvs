...
class InventoriesControllerTest < ActionController::TestCase
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post :create, inventory: { amount: @inventory.amount, location_id: @inventory.location_id, video_id: @inventory.video_id }
    end
  ...
  test "should update inventory" do
    put :update, id: @inventory, inventory: { amount: @inventory.amount, location_id: @inventory.location_id, video_id: @inventory.video_id }
    assert_redirected_to inventory_path(assigns(:inventory))
  end
